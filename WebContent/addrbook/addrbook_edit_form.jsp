...
<td>
<select name="addr">
	<option <%if (ab.getAddr().equals("제주")) 
		out.print("selected");%>> 제주</option>
	<option <%if (ab.getAddr().equals("부산")) 
		out.print("selected");%> >부산</option>
	<option <%if (ab.getAddr().equals("서울"))
		out.print("selected");%>>서울</option>
</select>
</td>
</tr>
